...
\begin{equation}
y(n) = x(0) \left[ \frac{r^n - 1}{r - 1} \right]
\end{equation}

For \( y(3) \):
\begin{equation}
y(3) = x(0) \left[ \frac{r^3 - 1}{r - 1} \right]
\end{equation}

For \( y(6) - y(3) \):
\begin{equation}
y(6) - y(3) = x(0) \left[ \frac{r^6 - 1}{r - 1} - \frac{r^3 - 1}{r - 1} \right]
\end{equation}

\begin{equation}
16 = x(0)\left[\frac{r^3 - 1}{r - 1}\right]
\end{equation}

\begin{equation}
128 = x(0)\left[\frac{r^6 - 1}{r - 1} - \frac{r^3 - 1}{r - 1}\right]
\end{equation}
...
Divide equation 8 by equation 7
