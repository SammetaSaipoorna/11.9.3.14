...
\begin{align}
    ...
    X(z) &= A \cdot \frac{1}{1 - r^{-1}} \label{eq:3} \\
    Y(z) &= A \cdot \frac{1}{(1 - r^{-1})^2} \label{eq:4}
\end{align}

Applying inverse Z-transform:
\begin{align}
y(n) &= x(0) \left[ \frac{r^n - 1}{r - 1} \right] \label{eq:5}
\end{align}
...
\begin{align}
y(3) &= x(0) \left[ \frac{r^3 - 1}{r - 1} \right] \label{eq:6}
\end{align}
$$
\text{For } y(6) - y(3):
$$
\begin{align}
y(6) - y(3) &= x(0) \left[ \frac{r^6 - 1}{r - 1} - \frac{r^3 - 1}{r - 1} \right] \label{eq:7}
\end{align}

\begin{align}
128 &= x(0)\left[\frac{r^6 - 1}{r - 1} - \frac{r^3 - 1}{r - 1}\right] \label{eq:8}
\end{align}

\begin{align}
128 &= x(0)r^3\left[\frac{r^3 - 1}{r - 1}\right] \label{eq:9}
\end{align}

\begin{align}
16 &= x(0)\left[\frac{r^3 - 1}{r - 1}\right] \label{eq:10}
\end{align}

Divide equation \eqref{eq:7} by equation \eqref{eq:8}:

\begin{align}
\frac{128}{16} &= r^3 \label{eq:11}
\end{align}
...
\begin{align}
x(0) &= \frac{16}{2^2 + 2 + 1} \label{eq:14} \\
&= \frac{16}{7} \label{eq:16}
\end{align}
